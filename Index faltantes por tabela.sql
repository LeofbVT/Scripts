--Index faltantes por tabela
USE database; 
SELECT TOP 10 DB_NAME(dm_mid.database_id) AS [Database]
		, user_seeks
		, user_scans
		, avg_user_impact
...
WHERE dm_mid.database_ID = 17
	AND OBJECT_NAME(dm_mid.OBJECT_ID,dm_mid.database_id) = 'Nome da Tabela'     
